          ...
          >
                ...
                return (
                  ...
                  >
                    ...
                    <button
                      ...
                      className="w-8 h-8 rounded-full bg-muted flex items-center justify-center hover:bg-surface-hover transition-colors"
                    >
            ...
            <div className="px-6 py-5 border-t border-[hsl(0_0%_100%/0.06)]">
              <motion.button
                ...
                className="w-full py-3 rounded-xl bg-foreground text-background font-medium text-sm flex items-center justify-center gap-2 hover:opacity-90 transition-opacity"
              >
